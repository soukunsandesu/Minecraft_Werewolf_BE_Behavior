...
execute if score MWSystem NumOfFox matches 1.. if score MWSystem NumOfWolf matches 0 as @p run function werewolf/onfinish/winner/fox
execute if score MWSystem NumOfFox matches 1.. if score MWSystem NumOfVillagers matches 0 as @p run function werewolf/onfinish/winner/fox
