...
# 村・人狼勝利判定
execute if score MWSystem NumOfVillagers matches 1.. as @p run function werewolf/onfinish/winner/villager
execute if score MWSystem NumOfWolf matches 1.. as @p run function werewolf/onfinish/winner/werewolf
