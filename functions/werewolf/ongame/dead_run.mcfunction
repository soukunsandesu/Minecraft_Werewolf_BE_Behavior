...
scoreboard players set @s[scores={portal=0..}] portal 0
...
# 猫又
# execute if entity @s[scores={CurrentRole=7}] run execute as @r[scores={a_live=1}] at @s run function werewolf/ongame/nekomata
