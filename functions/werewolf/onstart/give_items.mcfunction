...
loot give @a[scores={give_item=5}] loot "give_items/feather"
loot give @a[scores={give_item=5}] loot "give_items/feather"
loot give @a[scores={give_item=6}] loot "give_items/splash_potion31"
loot give @a[scores={give_item=7}] loot "give_items/wither_rose"
loot give @a[scores={give_item=8}] loot "give_items/shield"
loot give @a[scores={give_item=9}] loot "give_items/totem_of_undying"
loot give @a[scores={give_item=10}] loot "give_items/hopper"
loot give @a[scores={give_item=11}] loot "give_items/skull"
loot give @a[scores={give_item=12}] loot "give_items/golden_sword"
# 人狼専用
