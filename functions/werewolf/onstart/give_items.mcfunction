...
loot give @a[scores={give_item=5}] loot "give_items/splash_potion36"
...
# アイテム未定
loot give @a[scores={give_item=11}] loot "give_items/beacon"
loot give @a[scores={give_item=12}] loot "give_items/beacon"
loot give @a[scores={give_item=13}] loot "give_items/beacon"
loot give @a[scores={give_item=14}] loot "give_items/beacon"
loot give @a[scores={give_item=15}] loot "give_items/beacon"
loot give @a[scores={give_item=16}] loot "give_items/beacon"
loot give @a[scores={give_item=17}] loot "give_items/beacon"
loot give @a[scores={give_item=18}] loot "give_items/beacon"
